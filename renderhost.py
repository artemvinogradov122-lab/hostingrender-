...
TEXTS = {
    ...
    # ------------------ АНГЛИЙСКАЯ ВЕРСИЯ ------------------
    LANG_EN: {
        # (полный английский текст, аналогичный русскому, но для краткости не дублирую – он у вас уже есть)
        # Вставьте сюда ваш английский словарь
        'welcome': (
            "Welcome 👋\n\n"
        ...
        # ... и так далее (оставьте ваш полный английский словарь)
    }
}
